# PyCalc Pro V1.3 Source Code Date: 18/04/2025 Developer: LDM Dev. 

'''
PyCalc Pro V1.3 is a calculator with basic math operations, advanced math operations and and a unit converter function for mass and length 
...
def get_logo_path():
    if hasattr(sys, '_MEIPASS'):
        return os.path.join(sys._MEIPASS, 'PyCalc_Pro_V1.3_Logo.ico')
    else:
        return os.path.join(os.path.dirname(__file__), 'PyCalc_Pro_V1.3_Logo.ico')
...
def get_operations_file_path():
    if hasattr(sys, '_MEIPASS'):  
        return os.path.join(sys._MEIPASS, "PyCalcPro_V1.3_DATA.json")
    else: 
        return os.path.join(os.path.dirname(__file__), "PyCalcPro_V1.3_DATA.json")
...
def open_credit_window():
    ...
    credit_label = Label(credit_window, text="PyCalc Pro Version 1.3\nDeveloper: LDM Dev", font=("Arial", 18), bg="#1E1E1E", fg="white")
...
def open_license_window():
    ...
    # Title Label
    license_label = Label(license_window, text="PyCalc Pro Version 1.3 License", font=("Arial", 18), bg="#1E1E1E", fg="white")
    license_label.pack(pady=10)

    # License Text
    license_text = """Thank you for downloading PyCalc Pro V1.3. Before using the software, 
