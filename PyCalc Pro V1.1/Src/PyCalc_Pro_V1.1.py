# PyCalc Pro V1.1  Source Code Date: 08/03/2025 Developer: LDM Dev. 

'''
PyCalc Pro V1.1 is a calculator with basic math operations, advanced math operations and and a unit converter function for mass and length 

Git Hub Repository Link: "https://github.com/Lorydima/PyCalcPro"

Please read the Terms of Use on the main readme on git hub.

If you see any bugs or have suggestions, please open an issue on the GitHub repository.

Thank you for using PyCalc ProV.1.1 from LDM Dev
'''
# Library for app Dev.
...
def get_logo_path():
    if hasattr(sys, '_MEIPASS'):
        return os.path.join(sys._MEIPASS, 'PyCalc_Pro_V1.1_Logo.ico')
    else:
        return os.path.join(os.path.dirname(__file__), 'PyCalc_Pro_V1.1_Logo.ico')
...
def open_credit_window():
    ...
    credit_label = Label(credit_window, text="PyCalc Pro Version 1.1\nDeveloper: LDM Dev", font=("Arial", 18), bg="#1E1E1E", fg="white")
